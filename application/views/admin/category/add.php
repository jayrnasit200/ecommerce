            ...
            <div class="forms">
                    ...
                    <div class="form-body">
                        <form method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Category Name" name="name" value="<?php echo set_value('name');?>">
               ...
               <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                   ...
                   <div class="table-responsive bs-example widget-shadow">
                    ...
                    <table class="table table-bordered" id="tbl_cat">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>category Name</th>
