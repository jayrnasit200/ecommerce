					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								<li> <a href="<?php echo base_url();?>index.php/admin/change_pass"><i class="fa fa-cog"></i> Change passwoed</a> </li> 
								
								<li> <a href="<?php echo base_url();?>index.php/admin/login/logout"><i class="fa fa-sign-out"></i> Logout</a> </li>
							</ul>
						</li>
					</ul>
				</div>
