...
<!-- /banner_bottom_agile_info -->
  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
        ...
        <?php $CatName=$this->dbproduct->GetCatName($cat_id);?>
         <?php $SubCatName=$this->dbproduct->GetSubCatName($sub_cat_id);?>
		<div class="col-md-8 products-right">
			<h5><?php  echo $CatName->name;?> <u><span><?php echo $SubCatName->Name;?></span></u></h5>
			<div class="sort-grid">
				<div class="sorting">
					<h6>Sort By</h6>
