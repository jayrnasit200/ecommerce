...
<div class="banner-bootom-w3-agileits">
	<div class="container">
				...
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="images/d2.jpg">
                            ...
                            <img src="<?php echo base_url();?>upload_img/product/<?php echo $row->image; ?>" data-imagezoom="true" class="img-responsive">
                             </div>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price"><?php echo $row->sell_price?></span> <del>-<?php echo $row->price?></del></p>
					<div class="rating1">
